    ...
    const getNovels = async () => {
      ...
      try {
        const response = await axiosInstance.get("users/bookmarks", {
          params: {
            sort: activeFilters.sort.toLowerCase(),
            filter: activeFilters.filter.toLowerCase(),
          },
        });
          ...
          <div className="btn-container">
            <div className="fieldset">
              <input
                ...
                name="libfilter"
                value="All"
                checked={activeFilters.filter === "All"}
                onChange={() =>
            ...
            <div className="fieldset">
              <input
                ...
                name="libfilter"
                value="Updated"
                checked={activeFilters.filter === "Updated"}
                onChange={() =>
                  setActiveFilters(prevState => ({
                    ...prevState,
                    filter: "Updated",
            ...
            <div className="fieldset">
              <input
                ...
                name="libfilter"
                value="Favorites"
                checked={activeFilters.filter === "Favorites"}
                onChange={() =>
                  setActiveFilters(prevState => ({
                    ...prevState,
                    filter: "Favorites",
            ...
            <div className="fieldset">
              <input
                ...
                name="libfilter"
                value="Completed"
                checked={activeFilters.filter === "Completed"}
                onChange={() =>
                  setActiveFilters(prevState => ({
                    ...prevState,
                    filter: "Completed",
