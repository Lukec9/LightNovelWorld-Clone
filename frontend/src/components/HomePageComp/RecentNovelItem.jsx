  ...
  return (
    <li className="novel-item">
      ...
      <div className="item-stats">
        <Link to={`/novel/${novel.slugTitle}`} title="Novel Chapter">
        ...
        <div className="novel-stats">
          <span>
            ...
            <time dateTime={lastChapter.updatedAt || ""}>
              {timeAgo(new Date(lastChapter.updatedAt))}
            </time>
          </span>
        </div>
      </div>
...
export default RecentNovelItem;
