        ...
        <div className="nav-bar">
          <nav>
            ...
            <ul className="navbar-menu">
              ...
              {/* <li class="nav-item gear">
          <a
            class="nightmode_switch"
            data-tool="night"
            title="Dark Mode"
            data-night="0"
          >
          ...
          <div className="login-wrap-nav">
            ...
            <ul className="user-menu">
              ...
              <li className="user-item">
                <a className="with-badge" href="/account/library">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={16}
                    height={16}
              ...
              <li className="user-item user-mail">
                <a className="notification" href="/account/inbox">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={16}
                    height={16}
                  ...
                  <span className="newnotifymsg">No new notifications!</span>
                </a>
              </li>
            </ul>
          </div>
